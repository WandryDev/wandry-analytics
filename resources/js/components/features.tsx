        ...
        >
            <div className="@container mx-auto max-w-5xl px-6">
                <div className="text-center">
                    ...
                    <p className="mt-4">
                        Clean analytics for Shadcn Registry — no bloat, no
                        hidden layers. Just install, connect, and start
                        exploring the data that matters.
                    </p>
                </div>
                <Card className="mx-auto mt-8 grid max-w-sm divide-y overflow-hidden shadow-zinc-950/5 *:text-center md:mt-16 @min-4xl:max-w-full @min-4xl:grid-cols-3 @min-4xl:divide-x @min-4xl:divide-y-0">
                    <div className="group shadow-zinc-950/5">
                        ...
                        <CardContent>
                            <p className="mt-3 text-sm">
                                See up-to-date download stats for every
                                component. Stay informed about what’s trending
                                right now.
                            </p>
                        </CardContent>
                    </div>
                    ...
                    <div className="group shadow-zinc-950/5">
                        <CardHeader className="pb-3">
                            ...
                            <h3 className="mt-6 font-medium">
                                Component Popularity Insights
                            </h3>
                        </CardHeader>

                        <CardContent>
                            <p className="mt-3 text-sm">
                                Discover which UI components developers use most
                                — and how their adoption changes over time.
                            </p>
                        </CardContent>
                    </div>
                    ...
                    <div className="group shadow-zinc-950/5">
                        ...
                        <CardContent>
                            <p className="mt-3 text-sm">
                                Connect analytics effortlessly. Just install the
                                package and run one function — data tracking
